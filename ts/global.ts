...
const Global = (() => {
  ...
  const handleScrollToSection = () => {
    $(() => {
      $('a[href*=#js__scroll-to-]:not([href=#js__scroll-to-])').on('click', function(): void () {
  ...
  const handlePromoSection = () => {
    $('.js__fullwidth-img').each(function(): void () {
  ...
  const handleVerticalCenterAligned = () => {
    const centerElements = () => {
      $('.js__ver-center-aligned').each(function(): void () {
  ...
  const handleEqualHeight = () => {
    $('[data-auto-height]').each(function(): void () {
      const parent = $(this);
